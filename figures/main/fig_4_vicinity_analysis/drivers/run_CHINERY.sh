...
LD_matrix="../tz_LD_dist_mat_HB_LB.npy"

# Construct folder name
if [[ $sample_size == 0 ]]; then
  result_dir="../Vicinity_results_100k_4"
else
  result_dir="../Vicinity_results_100k_sample${sample_size}"
fi
    ...
    for model in "${models_s[@]}"; do
      for complexity in "${complexities[@]}"; do
        for chain in "${chains[@]}"; do
          ...
          # Construct folder name
          if [[ $sample_size == 0 ]]; then
            result_dir="../Vicinity_results_100k_Density2"
          else
            result_dir="../Vicinity_results_100k_Density2_sample${sample_size}"
          fi
