...
input_metadata="../data/sequences/porebski_metadata_vsALL.csv"
LD_matrix='../porebski_LD_matrix.npy'
      ...
      for complexity in "${complexities[@]}"; do
        for chain in "${chains[@]}"; do
          ...
          if [[ $sample_size == 0 ]]; then
            result_dir="../Vicinity_results_POREBSKI_Density2"
          else
            result_dir="../Vicinity_results_POREBSKI_Density2_sample${sample_size}"
          fi
