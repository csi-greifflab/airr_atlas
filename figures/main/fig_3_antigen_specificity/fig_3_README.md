...
| Script | Description |
|--------|-------------|
| `run_PEPE.sh` | Main driver for embedding extraction using `pepe-cli`. All embeddings used in the analysis were generated with this script. |
...
- `output/`: Output directory for generated figures.
