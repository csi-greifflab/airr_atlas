...
script="/doctorai/marinafr/2023/airr_atlas/analysis/scripts/reduce_dim.py"

input=("/doctorai/marinafr/2023/airr_atlas/analysis/output/esm2/all_data/all_data.pt")
output=("/doctorai/marinafr/2023/airr_atlas/analysis/output/esm2/all_data/all_data_100dim.pt")
