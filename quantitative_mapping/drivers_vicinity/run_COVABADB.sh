...
LD_matrix= '/doctorai/niccoloc/LD_covabdab_bg2.npy'
      ...
      for complexity in "${complexities[@]}"; do
        ...
        #   fi
          ...
          if [[ $sample_size == 0 ]]; then
            result_dir="/doctorai/niccoloc/Vicinity_results_COVABDAB_Density2"
          else
            result_dir="/doctorai/niccoloc/Vicinity_results_COVABDAB_Density2_sample${sample_size}"
          fi
