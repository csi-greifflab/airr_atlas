...
LD_matrix='/doctorai/niccoloc/LD_mat_brian_hie.npy'
      ...
      for complexity in "${complexities[@]}"; do
        for chain in "${chains[@]}"; do
          ...
          if [[ $sample_size == 0 ]]; then
            result_dir="/doctorai/niccoloc/Vicinity_results_BRIANHIE_Density2"
          else
            result_dir="/doctorai/niccoloc/Vicinity_results_BRIANHIE_Density2_sample${sample_size}"
          fi
