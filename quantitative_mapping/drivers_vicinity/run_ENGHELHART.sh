...
LD_matrix='/doctorai/niccoloc/LD_alphaseq_HB_LB.npy'
      ...
      for complexity in "${complexities[@]}"; do
        ...
        #   fi
          ...
          if [[ $sample_size == 0 ]]; then
            result_dir="/doctorai/niccoloc/Vicinity_results_ALPHASEQ_Density2_HB_LB"
          else
            result_dir="/doctorai/niccoloc/Vicinity_results_ALPHASEQ_Density2_sample${sample_size}"
          fi
