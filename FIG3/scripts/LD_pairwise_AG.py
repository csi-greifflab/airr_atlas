...
plt.tight_layout()
plt.savefig('../figures/FIG_S6_pairwise_levenshtein_distance_distributions_LEV_NORM2-3.png', bbox_inches='tight')
plt.clf()


#save the pairwise_results in the best format
import pickle
with open('../data/results/pairwise_levenshtein_distance_results_LEV_NORM.pkl', 'wb') as f:
    pickle.dump(pairwise_results, f)

#load the pairwise_results from the pickle file
import pickle
with open('../data/results/pairwise_levenshtein_distance_results_LEV_NORM.pkl', 'rb') as f:
