...
cd ../airr_atlas/scripts/Vicinity_code || {
...
input_metadata="../data/sequences/covabdab_AND_background.tsv"
LD_matrix= '../LD_covabdab_bg2.npy'
...
get_paths() {
  ...
  if [[ "$chain" == "paired_chain" || "$chain" == "all_cdrh" ]]; then
    ...
    input_idx="/doctorai/userdata/airr_atlas/data/embeddings/covabdab/${model}/covabdab_bg_ESM2_idx.csv"
    # input_idx="/scratch/niccoloc/covabdab/${model}/covabdab_bg_AB2_idx.csv"
    input_embeddings="/doctorai/userdata/airr_atlas/data/embeddings/covabdab/${model}/${complexity}/covabdab_${model}_${complexity}_layer_$((layer+1)).npy"
    ...
    input_embeddings="/doctorai/userdata/airr_atlas/data/embeddings/brian_hie/${model}/${complexity}/brian_hie_${model}_${complexity}_layer_$((layer+1)).npy"
  fi
}
      ...
      for complexity in "${complexities[@]}"; do
        ...
        #   fi
          ...
          if [[ $sample_size == 0 ]]; then
            result_dir="../Vicinity_results_COVABDAB_Density2"
          else
            result_dir="../Vicinity_results_COVABDAB_Density2_sample${sample_size}"
          fi
