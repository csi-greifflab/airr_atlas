...
ggsave("../figures/Vicinity_DENSITY_prelim.png", last_plot(), width =10, height =6.25, units = "in", dpi = 300)
...
ggsave("../figures/TZ_supplementary_layers.png", last_plot(),  width =10, height =6.25, units = "in", dpi = 300)
...
ggsave("../figures/DMS_supplementary_layers.png", last_plot(), width =10, height =6.25, units = "in", dpi = 300)
...
```{r Combined Plots and Final Adjustments}
library(patchwork)
library(cowplot)
library(grid)
library(gtable)
...
if (exists("density_main_fig")) {
  ...
  ggsave("../figures/airr_atlas/Vicinity_DENSITY_DIFF.png", density_main_fig, width = 9, height = 6, dpi = 300)
}

ggsave("../figures/airr_atlas/Vicinity_DENSITY_v2-22.png", v1, width = 8, height = 4.5, dpi = 300)
ggsave("../figures/airr_atlas/Vicinity_SAMPLE_SIZe_v2.png", s1, width = 8, height = 4.5, dpi = 300)
ggsave("../figures/airr_atlas/Vicinity_DENSITY_DMS_v2.png", dms1, width = 8, height = 4.5, dpi = 300)
...
if (exists("p_ag_spec")) {
  ...
  ggsave("../figures/airr_atlas/Ag_density.png", p_ag_spec, width = 16, height = 4.5, dpi = 301)
}
...
if (exists("suppl_DENS")) {
  ...
  ggsave("../figures/airr_atlas/Supplementary_DENSITY_TSNE.png", suppl_DENS, width = 12, height = 4.5, dpi = 600)
}
```
