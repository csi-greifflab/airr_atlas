...
ggsave("../figures/FIG_4C_Vicinity_DENSITY_prelim.png", last_plot(), width =10, height =6.25, units = "in", dpi = 300)
...
ggsave("../figures/FIG_S8_TZ_supplementary_layers.png", last_plot(),  width =10, height =6.25, units = "in", dpi = 300)
...
ggsave("../figures/FIG_S10_DMS_supplementary_layers.png", last_plot(), width =10, height =6.25, units = "in", dpi = 300)
...
if (exists("density_main_fig")) {
  ...
  ggsave("../figures/Vicinity_DENSITY_DIFF.png", density_main_fig, width = 9, height = 6, dpi = 300)
}

ggsave("../figures/Vicinity_DENSITY_v2-22.png", v1, width = 8, height = 4.5, dpi = 300)
ggsave("../figures/FIG_4D_Vicinity_SAMPLE_SIZe_v2.png", s1, width = 8, height = 4.5, dpi = 300)
ggsave("../figures/FIG_4E_Vicinity_DENSITY_DMS_v2.png", dms1, width = 8, height = 4.5, dpi = 300)
...
if (exists("p_ag_spec")) {
  ...
  ggsave("../figures/FIG_3B_Ag_density.png", p_ag_spec, width = 16, height = 4.5, dpi = 301)
}
...
if (exists("suppl_DENS")) {
  ...
  ggsave("../figures/FIG_S7_Supplementary_DENSITY_TSNE.png", suppl_DENS, width = 12, height = 4.5, dpi = 600)
}
```
